...
// Product images are generated client-side as inline SVGs in the widget.
// These IDs map to empty strings; the widget's getProductImage() handles rendering.
const PRODUCT_IMAGES: Record<string, string> = {};

function getProductImage(_productId: string): string {
  return PRODUCT_IMAGES[_productId] || "";
}
